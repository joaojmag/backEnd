...
@Table(name = "classes") // Especifica o nome da tabela no banco de dados para a entidade "Class".
...
public class Class {
    ...
    private String taught; // Campo que representa se a classe foi lecionada ou não.
 
    public Class() {
        // Construtor padrão vazio, necessário para o JPA.
    }
 
    public Class(String title, String description, String taught) {
        this.title = title;
